...
function createPrintable() {
  ...
  printable.innerHTML = `
    ...
    <div class="d-flex flex-column">
        ...
        <h3 class="mt-2">Conserva la pellicola originale e attiva il servizio di "Garanzia a Vita"</h3>
        </div>
        ...
        <div class="d-flex flex-row flex-wrap">
            ...
            <div class="text-center px-3">
                <h3>RESTITUZIONE</h3>
                <p class="desc-p">Il Cliente dichiara che il prodotto è stato <b>restituito</b> dall'operatore regolarmente funzionante e in buono stato di conservazione, non rinvenendo alcun danno al dispositivo.</p>
                <div class="d-flex flex-column">
                    <b><em>Firma Cliente</em></b>
                    <hr style="border: solid 1px black" class="my-3"/>
                    <b><em>Firma Operatore</em></b>
